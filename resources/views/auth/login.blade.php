...
<body class="text-center">
    <form class="form-signin" method="POST" action="{{ url('/login') }}" autocomplete="off">
        ...
        <p class="mt-5 mb-3 text-muted" style="color:cornsilk">&copy; 2019 by @dikiwidia | Repost by <a href="https://stokcoding.com/" title="StokCoding.com" target="_blank">StokCoding.com</a></p>
    </form>
</body>
</html>
